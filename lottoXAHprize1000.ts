...
//export const Hook: Hook = (tx) => {
    ...
    // If P1 Wins, we send 1000 XAH to him
    if(lastDigit == 0){
    ...
    //If P2 Wins, we send 1000 XAH to him
    if(lastDigit == 1){
        //Let's create the outgoing payment
        const prepared_txn = prepare({
            TransactionType: "Payment",
    ...
    // If P3 Wins, we send 1000 XAH to him
    if(lastDigit == 2){
        //Let's create the outgoing payment
        const prepared_txn = prepare({
            TransactionType: "Payment",
    ...
    // If P4 Wins, we send 1000 XAH to him
    if(lastDigit == 3){
        //Let's create the outgoing payment
        const prepared_txn = prepare({
            TransactionType: "Payment",
    ...
    // If P5 Wins, we send 1000 XAH to him
    if(lastDigit == 4){
        //Let's create the outgoing payment
        const prepared_txn = prepare({
            TransactionType: "Payment",
    ...
    // If P6 Wins, we send 1000 XAH to him
    if(lastDigit == 5){
        //Let's create the outgoing payment
        const prepared_txn = prepare({
            TransactionType: "Payment",
    ...
    // If P7 Wins, we send 1000 XAH to him
    if(lastDigit == 6){
        //Let's create the outgoing payment
        const prepared_txn = prepare({
            TransactionType: "Payment",
    ...
    // If P8 Wins, we send 1000 XAH to him
    if(lastDigit == 7){
        //Let's create the outgoing payment
        const prepared_txn = prepare({
            TransactionType: "Payment",
    ...
    // If P9 Wins, we send 1000 XAH to him
    if(lastDigit == 8){
        //Let's create the outgoing payment
        const prepared_txn = prepare({
            TransactionType: "Payment",
    ...
    // If P10 Wins, we send 1000 XAH to him
    if(lastDigit == 9){
        //Let's create the outgoing payment
        const prepared_txn = prepare({
            TransactionType: "Payment",
    ...
    accept("LOTTO XAH: Saving Player 10. Player 10 has position number 9. If Ledger Index last digit of this transaction is the number 9, then you win 1000 XAH! If it is another number, you lose! End of the game. Check the data in the explorer to know the winner.", 14)
    }
